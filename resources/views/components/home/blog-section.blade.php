    ...
    <div class="max-w-[1100px] mx-auto px-5">
        <div class="mb-16 relative">
            ...
            <div class="max-w-2xl mx-auto text-center space-y-4">
                ...
                <p class="text-lg text-muted-foreground leading-relaxed"   data-aos="fade-up" data-aos-delay="160" data-aos-once="true">
            ...
            <div
                ...
                <a href="{{ url('/blog') }}" class="btn-secondary inline-flex items-center gap-2 px-4 py-2 w-auto"
                    style="font-weight:600;" data-aos="fade-left" data-aos-delay="220" data-aos-once="true">
                    View All Articles
...
@push('scripts')
    <script>
        // Refresh AOS after blog images load so AOS measures positions correctly
        document.addEventListener('DOMContentLoaded', function () {
            if (!window.AOS) return;
            const blogSection = document.getElementById('blog');
            if (!blogSection) { AOS.refresh(); return; }

            const imgs = Array.from(blogSection.querySelectorAll('img'));
            if (imgs.length === 0) {
                AOS.refresh();
                return;
            }
            ...
            // Fallback: ensure refresh after short timeout in case loads hang
