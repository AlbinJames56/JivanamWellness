    ...
    <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
      ...
      <div class="space-y-8">
        <div class="space-y-6">
          ...
          <!-- Main Heading -->
          <h1 class="hero-heading text-foreground">
            Restore Balance with <span class="text-primary">Authentic Ayurveda</span>
          </h1>

          <!-- Description -->
          <p class="hero-description text-muted-foreground  ">
            Experience holistic healing through time-tested Ayurvedic treatments. Our certified practitioners combine ancient wisdom with modern care to restore your natural balance and vitality.
          </p>

          <!-- CTA Buttons -->
          <div class="flex flex-col sm:flex-row gap-4">
            <button class="btn-primary hover:bg-primary/90 shadow-lg transition-colors duration-200 inline-flex items-center justify-center">
            ...
            <button class="btn-secondary hover:border-border/80 hover:bg-card/80 transition-colors duration-200">
        ...
        <div class="flex flex-wrap gap-3">
          ...
          @foreach ($features as $feature)
            <div class="flex items-center gap-2 bg-card/80 backdrop-blur-sm rounded-full px-4 py-2 border border-border shadow-sm">
      ...
      <!-- Right Content - Image with Card -->
      <div class="relative">
        <!-- Main Image Container -->
        <div class="relative rounded-2xl overflow-hidden shadow-2xl bg-card">
            ...
            <div class="card backdrop-blur-sm shadow-lg">
              <div class="flex items-center justify-between">
                <div class="flex-1">
                  ...
                  <p class="text-muted-foreground mt-1">Discover your dosha and personalized wellness plan</p>
                </div>
                <div class="ml-4 bg-primary/10 rounded-full p-3">
