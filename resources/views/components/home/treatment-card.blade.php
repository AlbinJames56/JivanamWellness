{{-- resources/views/components/home/treatment-card.blade.php --}}
@props([
    'title',
    'description' => null,
    'image' => null,
    'duration' => null,
    'featured' => false,
    'model' => null, // Eloquent model preferred
])
 ...
 * adjust the route name below.
 */
$detailUrl = $slug ? route('therapies.show', $slug) : '#';
@endphp
