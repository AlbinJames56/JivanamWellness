...
@section('content')
    <section class="bg-background">
        <div class="max-w-[1100px] mx-auto px-5 pt-12 mt-8 pb-8">
            ...
            {{-- Main Doctors (only if present) --}}
            @if(!empty($mainDoctors) && $mainDoctors->isNotEmpty())
                <div class="mb-12">
                    <h2 class="text-xl md:text-2xl font-semibold text-foreground mb-4"> Our Doctors</h2>
            ...
            {{-- Other Duty Doctors (only if present) --}}
            @if(!empty($dutyDoctors) && $dutyDoctors->isNotEmpty())
                <div class="mb-24">
                    <h2 class="text-xl md:text-2xl font-semibold text-foreground mb-4">Meet Our Doctors</h2>
