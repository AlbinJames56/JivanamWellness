...
$certifications = [
    ...
    <div class="min-h-screen bg-background">
        ...
        <section class="relative py-10 lg:py-16 bg-gradient-to-br from-muted/20 to-background">
            <div class="max-w-[1200px] mx-auto px-5">
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    <div class="space-y-6">
                        <span class="inline-block badge-accent" data-aos="fade-up" data-aos-delay="80">About AyurVeda
                            Clinic</span>
                        ...
                        <div class="space-y-4 text-lg text-muted-foreground leading-relaxed" data-aos="fade-up"
                            data-aos-delay="260">
                            <p>
                        ...
                        <a href="#team" class="inline-flex items-center gap-3 btn-primary" data-aos="zoom-in"
                            data-aos-delay="340">
                            {{-- calendar svg --}}
                    ...
                    <div class="relative" data-aos="fade-left" data-aos-delay="220">
        ...
        <section class="py-16 lg:py-24">
            <div class="max-w-[1200px] mx-auto px-5">
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    <div class="order-2 lg:order-1" data-aos="fade-right" data-aos-delay="160">
                    ...
                    <div class="order-1 lg:order-2 space-y-6" data-aos="fade-left" data-aos-delay="200">
                        ...
                        <div class="flex items-center gap-4 pt-2" data-aos="fade-up" data-aos-delay="260">
        ...
        <section class="py-16 lg:py-24 bg-gradient-to-br from-primary/5 to-muted/20">
            <div class="max-w-[1200px] mx-auto px-5">
                <div class="text-center space-y-4 mb-12">
                    <h2 class="text-3xl lg:text-4xl font-semibold text-foreground" data-aos="fade-up" data-aos-delay="120">
                        Our Core Values</h2>
                    <p class="text-lg text-muted-foreground   mx-auto" data-aos="fade-up" data-aos-delay="180">The
                        principles that guide everything we do in our
                        mission to heal and nurture</p>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    @foreach ($values as $value)
                        <div class="card p-6 hover:shadow-md transition-shadow" data-aos="fade-up"
        ...
        <section id="team" class="py-16 lg:py-24">
            ...
            <div class="max-w-[1200px] mx-auto px-5">
                <div class="text-center space-y-4 mb-12">
                    ...
                    <p class="text-lg text-muted-foreground  mx-auto" data-aos="fade-up" data-aos-delay="180">Experienced
                        practitioners dedicated to your wellness
                        journey</p>
                </div>
        ...
        <section class="py-16 lg:py-24 bg-muted/30">
            <div class="max-w-[1200px] mx-auto px-5">
                <div class="text-center space-y-4 mb-12">
                    <h2 class="text-3xl lg:text-4xl font-semibold text-foreground" data-aos="fade-up" data-aos-delay="120">
                        Certifications & Recognition</h2>
                    <p class="text-lg text-muted-foreground" data-aos="fade-up" data-aos-delay="180">Trusted by authorities
                        and recognized for excellence</p>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($certifications as $cert)
                        <div class="flex items-center gap-3 p-4 bg-card border border-border rounded-lg" data-aos="fade-up"
                            data-aos-delay="{{ $loop->index * 80 }}">
                            {{-- check icon --}}
